...
const ChatBotApp = ({ onGoBack, chats, setChats, activeChat, setActiveChat, onNewChat }) => {
  ...
  const sendMessage = async () => {
    ...
    localStorage.setItem(activeChat, JSON.stringify([...messages, newMessage]));
    ...
    try {
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        headers: {
          ...
          Authorization: `Bearer 1OqJuuPXYAWJc-R0Geu7niD01wkLIgrTquT3BlbkFJJ_N-h0k1_5tjnS8qUvARxrax7aYCtVbRL1UxeHCNM8-zf2eBDHcmNCp_C7ANKOL5TP2omCO1oA`, // Replace with a valid API key
        },
        body: JSON.stringify({
          model: 'gpt-3.5-turbo',
      ...
      if (chatResponse) {
        ...
        localStorage.setItem(activeChat, JSON.stringify([...messages, newMessage, newResponse]));
      }
    } catch (error) {
